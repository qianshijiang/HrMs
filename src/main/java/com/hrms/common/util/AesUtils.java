...
public class AesUtils {
   ...
   * 默认的初始化向量值
   */
  private static final String IV_DEFAULT = "g2x20TrvOmIx2UuR";
  /**
   * 默认加密的KEY
   */
  private static final String KEY_DEFAULT = "9G5P8Ff9hEl8fXA9";
  /**
   * 工作模式：CBC
   */
...
//            初始化向量器
  ...
  public static void main(String[] args) {
    ...
    String encryptedStr2 = AesUtils.encryptEcbMode("{\"username\":\"Tom\",\"password\":\"123456\",\"mobile\":\"12306\",\"email\":\"admin@qsj.cn\"}", "4Ct7TyXZa19rgQKK");
